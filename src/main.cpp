...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("116.202.17.166", 21914), true);
  }
  do {
    db.Add(CService("108.61.163.182", 19914), true);
    db.Add(CService("195.181.242.206", 19914), true);
    db.Add(CService("94.102.52.66", 19914), true);
    db.Add(CService("45.79.94.206", 19914), true);
    db.Add(CService("95.217.78.79", 19914), true);
